<?php
	//发送短信校验码
		...
		$options['accountsid']='aa36cae402dc418b9e33c39d3cacb1bb';
		//填写在开发者控制台首页上的Auth Token
		$options['token']='1050354f0986dcfa2c0e94ed53b8530d';
		//初始化 $options必填
		$ucpass = new Ucpaas($options);
		$appid = "62033cac5db64b0bbef2cc8aa49eea8e"; //应用的ID，可在开发者控制台内的短信产品下查看
		$templateid = "481509"; //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模
		//板ID
		$param = rand(1,1000000); //多个参数使用英文逗号隔开（如：param=“a,b,c”），如为参数则
		//留空
		$mobile = $p;
		$uid = "";
